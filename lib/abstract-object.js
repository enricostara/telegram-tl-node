...
//
// The `AbstractObject` class is an abstraction of the `TypeLanguage Objects and Methods` providing
// read/write methods to serialize/de-serialize the TypeLanguage binary format
...
AbstractObject.prototype._writeBigInt = function (bigInteger, byteLength) {
