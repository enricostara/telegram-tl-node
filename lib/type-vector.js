...
// De-serializes the list starting from the initialized buffer
...
// Serializes the list starting from the initialized buffer
...
// Retrieves a copy of the internal list
TypeVector.prototype.getList = function () {
    return this.list.slice();
};

// Retrieves an element by id if any
