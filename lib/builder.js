...
// Return the required lib module/class
var lib;
Builder.prototype.requireFromLib = function (module) {
    lib = lib || {
        mtproto : require('lib/mtproto'),
        'type-language' : require('lib/type-language')
    };
    return lib[module];
};
...
Builder.prototype.buildTypeFunction = function () {
    ...
    typeFunction.require = this.requireFromLib;
